...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http
                ...
                .and()
                .authorizeRequests()
                .antMatchers("/", "/css/**", "/images/**", "/sass/**", "/webfonts/**","/js/**", "/h2-console/**", "/profile", "/notice", "/free", "/voteinfo", "/candidatelist", "/userinfo", "/pledges", "/signature", "/vote", "/api/v2/**", "/api/v3/**", "/result", "/candidatelist", "/regcandidate").permitAll()
